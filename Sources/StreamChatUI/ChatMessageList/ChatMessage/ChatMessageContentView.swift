...
open class _ChatMessageContentView<ExtraData: ExtraDataTypes>: _View, UIConfigProvider {
    ...
    open func setupQuoteView() {
        ...
        // Remove default margins of container view
        self.messageQuoteView?.layout.containerConstraints.forEach {
            $0.constant = 0
        }
        self.messageQuoteView?.contentView.backgroundColor = uiConfig.colorPalette.background1
    ...
    open func updateQuotedMessageViewIfNeeded() {
        ...
        quotedMessageView.content = (message.quotedMessage, .auto)
